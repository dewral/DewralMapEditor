...
Item {
    ...
    Loader {
        id: controlLoader
        anchors.fill: parent
        sourceComponent: (Backend.uiTheme.style === "classic" || Backend.uiTheme.style === "windows-classic") ? classicSpinBox : ((Backend.uiTheme.style === "gray-dark" || Backend.uiTheme.style === "gray-modern") ? graySpinBox : githubSpinBox)
    }
    Component {
        id: classicSpinBox
